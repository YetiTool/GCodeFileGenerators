# Cuts slots in same direction, alternates starting conditions (y has just moved + or -)
...
while channel < number_of_channels_per_test:
    ...
    lines.append("G0 Y" + str(y - back_lash_soak))
...
f = open("alternating_y_backlash.nc", "w")
for line in lines:
    f.write(line + "\n")   
